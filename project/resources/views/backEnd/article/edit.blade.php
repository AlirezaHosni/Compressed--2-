...
{{--                                                <input class="form-control"  name="publishDate" placeholder="تاریخ انتشار" type="text" data-jdp value="{{$article->publishDate}}" />--}}
                                                <input type="text" name="publishDate" id="publishDate" class="form-control form-control-sm d-none" value="{{ $article->publishDate }}">
                                                <input type="text" id="publishDate_view" class="form-control form-control-sm" value="{{ $article->publishDate }}">
                                            </div>
                                            <div class="form-group">
