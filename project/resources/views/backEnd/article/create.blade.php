                        ...
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-between">
                                    <label class="main-content-label mb-0 pt-1">درج مقاله</label>
                                    <div class="mr-auto float-right">
                                        <a href="{{route('article.index')}}" class="btn btn-info"> <i class="fa fa-arrow-right mx-2"></i>برگشت به لیست</a>
                                    </div>
                                </div>
                                <p class="tx-12 tx-gray-500 mt-0 mb-2">مدیریت / درج مقاله </p>
                                <form action="{{route('article.store')}}" method="post" enctype="multipart/form-data" class="my-5">
                                    @csrf
...
{{--                                                <input class="form-control"  name="publishDate" placeholder="تاریخ انتشار" type="text" data-jdp />--}}
                                                ...
                                                <input type="text" id="publishDate_view" class="form-control form-control-sm" placeholder="تاریخ انتشار">
                                            </div>
                                            <div class="form-group">
