                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                ...
                                <div class="d-flex">
                                    <p class="mx-2">توسط</p>
                                    <a class="mx-2" href="" style="color: blue;">{{implode(',',$article->user()->get()->pluck('name')->toArray())}}</a>
                                </div>
                                <hr />
                                <div class="d-flex">
                                    @php $v=\Hekmatinasser\Verta\Facades\Verta::instance($article->created_at) @endphp
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <img src="{{asset('upload/article/'.$article->image)}}" width="100%" class="mb-3" alt="" />
                                    </div>
                                </div>
                                <hr />
                                <!-- content-article -->
