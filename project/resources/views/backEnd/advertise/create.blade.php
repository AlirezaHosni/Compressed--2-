                        ...
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-between">
                                    <label class="main-content-label mb-0 pt-1">ایجاد تبلیغات</label>
                                    <div class="mr-auto float-right">
                                        <a href="{{route('advertise.index')}}" class="btn btn-info"> <i class="fa fa-arrow-right mx-2"></i>برگشت به لیست</a>
                                    </div>
                                </div>
                                <p class="tx-12 tx-gray-500 mt-0 mb-2"> مدیریت / تبلیغات/  ایجاد تبلیغات </p>
                                <form action="{{route('advertise.store')}}" method="post" enctype="multipart/form-data" class="my-5">
                                    @csrf
                                    <div class="d-flex row ">
                                        <div class="col-xl-6 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="advertiseTitle" class="form-control meta-keyboard" placeholder="عنوان تبلیغ " />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="imageAlt" class="form-control meta-keyboard" placeholder=" تگ آلت " />
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="systemName" class="form-control tag-img-main" placeholder=" نام سیستمی   " />
                                            </div>
                                            <div class="form-group">
