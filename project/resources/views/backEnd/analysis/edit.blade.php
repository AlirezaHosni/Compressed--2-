                        ...
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-between">
                                    <label class="main-content-label mb-0 pt-1">ویرایش تحلیل</label>
                                    <div class="mr-auto float-right">
                                        <a href="{{route('analysis.index')}}" class="btn btn-info"> <i class="fa fa-arrow-right mx-2"></i>برگشت به لیست</a>
                                    </div>
                                </div>
                                <p class="tx-12 tx-gray-500 mt-0 mb-2">مدیریت / ویرایش تحلیل </p>
                                <form action="{{route('analysis.update',$analysis->id)}}" method="post" enctype="multipart/form-data" class="my-5">
                                    @csrf
                                    @method('put')
                                    <div class="row d-flex">
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <input type="text" name="title" class="form-control " placeholder="عنوان تحلیل" value="{{$analysis->title}}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex row ">
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="titleTwo" class="form-control down-title-blog-create"
                                                       placeholder="زیر عنوان تحلیل" value="{{$analysis->titleTwo}}" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="imageAlt" class="form-control tag-img-main" placeholder=" تگ آلت عکس اصلی" value="{{$analysis->imageAlt}}" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="metaKeyWords" class="form-control meta-keyboard" placeholder="متا کیوورد" value="{{$analysis->metaKeyWords}}" />
                                            </div>
                                            @cannot('تحلیلگر')
                                            <div class="form-group">
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-group">
{{--                                                <input class="form-control"  name="publishDate" placeholder="تاریخ انتشار" type="text" data-jdp value="{{$analysis->publishDate}}" />--}}
                                                <input type="text" name="publishDate" id="publishDate" class="form-control form-control-sm d-none" value="{{ $analysis->publishDate }}">
                                                <input type="text" id="publishDate_view" class="form-control form-control-sm" value="{{ $analysis->publishDate }}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="addres-article" name="url" class="form-control addres-article-input text-left"
                                                       value="{{mt_rand(1000,10000)}}" value="{{$analysis->url}}" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control meta-discription" name="metaDescription" placeholder="متا دیسکریپشن" value="{{$analysis->metaDescription}}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <div class="row justify-content-center  mb-5">
                                                ...
                                                <div class="drop-zone col-10">
                                                    ...
                                                    <img src="{{asset('upload/analysis/'.$analysis->image)}}"  width="150px" height="150px">
