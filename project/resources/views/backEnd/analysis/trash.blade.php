                        ...
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-between">
                                    <label class="main-content-label mb-0 pt-1">تحلیل‌های حذف شده </label>

                                    <div class="mr-auto float-right">
                                        <a href="{{route('analysis.index')}}" class="btn btn-info"> <i class="fa fa-arrow-right mx-2"></i>برگشت به لیست</a>
                                    </div>
                                </div>
                                <p class="tx-12 tx-gray-500 mt-0 mb-2">مدیریت / تحلیل‌های حذف شده</p>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive border userlist-table">
                                    <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-lg-8p"><span>تحلیلگر</span></th>
                                      ...
                                      @foreach($analysis as $key=>$item)
                                          <tr>
                                              ...
                                              <td>
                                                  <form action="{{route('analysis.Trash.Restore',$item->id)}}" method="post">
                                                      @csrf
                                                      <button class="btn btn-primary"><i class="fe fe-clock"></i></button>
                                                  </form>
                                                  <form action="{{route('analysis.Trash.Destroy',$item->id)}}" method="post">
                                                      @csrf
                                                      @method('delete')
