    ...
    <div class="container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo text-center">
                <a href="index.html"><img src="{{asset('backEnd/img/brand/logo.png')}}" height="50px" class="" alt="لوگو" /></a>
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="dropdown main-header-notification">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="main-notification-list">
                        <div class="media new">
                            <div class="main-img-user online"><img alt="آواتار" src="{{asset('backEnd\img\users\5.jpg')}}" /></div>
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="#">
                    <span class="main-img-user"><img alt="آواتار" src="{{asset('upload/users/'.auth()->user()->image)}}" /></span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title">{{auth()->user()->name}}</h6>

                        <p class="main-notification-text">{{implode(',',auth()->user()->roles()->get()->pluck('name')->toArray())}}</p>
                    </div>

                    <a class="dropdown-item border-top" href="profile.html"> <i class="fe fe-user"></i> پروفایل من </a>
                    <a class="dropdown-item" href="{{route('userManagement.edit',auth()->user()->id)}}"> <i class="fe fe-edit"></i> ویرایش نمایه </a>
